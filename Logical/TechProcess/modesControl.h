...
/* оличество датчиков местного управлени€*/
...
/*ѕроверка условий останова автоматического режима*/
...
/*ѕроверка условий и запуск автоматического режима управлени€*/
int checkAutoMode()
{
	...
	{
		(TON_count.ET < 30000) ? (pulseSignal = 1) : (pulseSignal = 0);	//ѕульсирующий сигнал техн. светофоров
		autoMode = 1;
	}
	else 
	{
...
/*ѕроверка условий и запуск ручного режима управлени€*/
int checkManMode()
{
